  ...
  <div class="container">
    <div class="game-panel">
      <div v-for="(row, i) in gamePanel" :key="row + i" class="row">
        <div v-for="(col, index) in row" :key="'col' + index" class="col" :class="blockColors[i + 1 + '' + col]"
             @click="cleanBlock(i + 1 + '' + col)">
        </div>
      </div>
    </div>
...
<style scoped>
  ...
  .red {
    ...
    background-image: url(../assets/img/game/game1/0.png);
  }

  .yellow {
    background-repeat: no-repeat;
    background-image: url(../assets/img/game/game1/1.png);
  }

  .blue {
    background-repeat: no-repeat;

    background-image: url(../assets/img/game/game1/2.png);

  }

  .green {
    background-repeat: no-repeat;
    background-image: url(../assets/img/game/game1/3.png);
  }
